...
<html lang="en">
    ...
    <body class="body-vehicle">
        ...
        <p> <br>Nos vehicules représentent l'intérêt porté au prestige de notre clientèle.<br>
        <br>cliquer sur le vehicule de votre choix afin d'obtenir ses caractéristiques.</p>
        <div  class="listeCars">
